// <copyright file="ReportTreeController.cs" company="Logikfabrik">
...
namespace Logikfabrik.Umbraco.Jet.Social.Web.Trees
{
    ...
    public class ReportTreeController : DateTreeController
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReportTreeController" /> class.
        /// </summary>
        /// <param name="localizedTextService">The localized text service.</param>
        public ReportTreeController(ILocalizedTextService localizedTextService)
