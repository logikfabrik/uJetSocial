// <copyright file="DocumentTreeController.cs" company="Logikfabrik">
...
namespace Logikfabrik.Umbraco.Jet.Social.Web.Trees
{
    ...
    /// <summary>
    /// The <see cref="DocumentTreeController" /> class.
    /// </summary>
    [PluginController("uJetSocial")]
    [Tree("uJetSocial", "ujetDocument", "Documents")]
    public class DocumentTreeController : TreeController
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentTreeController" /> class.
        /// </summary>
        /// <param name="localizedTextService">The localized text service.</param>
        public DocumentTreeController(ILocalizedTextService localizedTextService)
