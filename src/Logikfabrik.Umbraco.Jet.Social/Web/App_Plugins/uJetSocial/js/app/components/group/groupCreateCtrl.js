(function () {
    ...
    ujetGroupCreateCtrl.$inject = ["$scope", "$location", "notificationsService", "ujetGroupFactory"];

    function ujetGroupCreateCtrl($scope, $location, notificationsService, ujetGroupFactory) {
        var vm = this;
