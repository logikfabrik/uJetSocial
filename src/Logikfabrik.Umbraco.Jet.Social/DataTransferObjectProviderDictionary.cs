// <copyright file="DataTransferObjectProviderDictionary.cs" company="Logikfabrik">
...
namespace Logikfabrik.Umbraco.Jet.Social
{
    ...
    /// <summary>
    /// The <see cref="DataTransferObjectProviderDictionary" /> class.
    /// </summary>
    public class DataTransferObjectProviderDictionary : IDictionary<Type, IDataTransferObjectProvider>
    {
        private readonly Dictionary<Type, IDataTransferObjectProvider> _innerDictionary = new Dictionary<Type, IDataTransferObjectProvider>();
        ...
        /// </summary>
        public ICollection<IDataTransferObjectProvider> Values => _innerDictionary.Values;
        ...
        public IDataTransferObjectProvider this[Type key]
        {
        ...
        public IEnumerator<KeyValuePair<Type, IDataTransferObjectProvider>> GetEnumerator()
        {
        ...
        public void Add(KeyValuePair<Type, IDataTransferObjectProvider> item)
        {
        ...
        /// </returns>
        public bool Contains(KeyValuePair<Type, IDataTransferObjectProvider> item)
        {
        ...
        public void CopyTo(KeyValuePair<Type, IDataTransferObjectProvider>[] array, int index)
        {
        ...
        /// </returns>
        public bool Remove(KeyValuePair<Type, IDataTransferObjectProvider> item)
        {
        ...
        public void Add(Type key, IDataTransferObjectProvider value)
        {
        ...
        /// </returns>
        public bool TryGetValue(Type key, out IDataTransferObjectProvider value)
        {
